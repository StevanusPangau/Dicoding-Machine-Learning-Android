...
import com.dicoding.picodiploma.mytextrecognitionandtranslation.databinding.ActivityResultBinding
...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // membuat fungsi untuk translate text
    ...
    private fun translateText(detectedText: String?) {
        ...
        // Mendownload model yang diperlukan saja agar tidak memakan banyak memori
        val conditions = DownloadConditions.Builder()
            .requireWifi() // Mendownload model hanya saat terhubung ke wifi
            .build()
